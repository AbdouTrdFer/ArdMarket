...
export default function ConnexionDarija() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message || "الإيميل ولا كلمة السر غالطين");
    } finally {
      setLoading(false);
    }
  };
            ...
            {[
              ...
              <a
                ...
                style={{
                  fontSize: 14,
                  fontWeight: 500,
                  color: active ? "#00694c" : "#4b5563",
                  textDecoration: "none",
                  borderBottom: active ? "2px solid #00694c" : "none",
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  أحسن منصة للأراضي الفلاحية فالمغرب.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} style={{ padding: 40 }}>
                ...
                >
                  ...
                  >
                    {loading ? "تسجيل الدخول..." : "دوز للكونيكسيون"}
                  </button>
                </div>
            ...
            >
              {[
                ["verified_user", "مأمن بالSSL"],
                ["policy", "مطابق للقانون المغربي"],
              ].map(([icon, label]) => (
                <div
                  key={label}
