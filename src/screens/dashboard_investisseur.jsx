export default function DashboardInvestisseur() {
  const cards = [
    {
      title: "Domaine de l'Olivier",
      location: "Meknès, Maroc",
      surface: "65 Ha",
      rendement: "75,000 DH/an",
      score: 95,
      scoreColor: "#00694c",
      scoreBar: "95%",
      validated: true,
    ...
    {
      title: "Ferme Agrumes Atlas",
      location: "Souss, Maroc",
      surface: "40 Ha",
      rendement: "120,000 DH/an",
      score: 78,
      scoreColor: "#704200",
      scoreBar: "78%",
      validated: false,
    ...
    {
      title: "Plaine du Gharb",
      location: "Gharb, Maroc",
      surface: "150 Ha",
      rendement: "85,000 DH/an",
      score: 88,
      scoreColor: "#00694c",
      scoreBar: "88%",
      validated: true,
          ...
          >
            ...
            <div style={{ flex: 1, maxWidth: 512, padding: "0 16px" }}>
              <div style={{ position: "relative", width: "100%" }}>
                ...
                <input
                  type="text"
                  placeholder="Rechercher une région, un type de culture..."
                  style={{
                    width: "100%",
                    paddingLeft: 40,
                    paddingRight: 16,
          ...
          >
            ...
            >
              ...
              <div>
                ...
                {[
                  { label: "Arboriculture", checked: true },
          ...
          <main style={{ flex: 1, padding: "24px 40px" }}>
            <div style={{ marginBottom: 16 }}>
              ...
              <p style={{ fontSize: 14, color: "#3d4943" }}>
                Découvrez des domaines agricoles vérifiés à haut rendement.
              </p>
            </div>
